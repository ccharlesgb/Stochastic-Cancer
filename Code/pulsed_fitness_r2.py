...
def pulse_r2(sim):
    ...
    sim.r2 = SimTools.PulseWave(sim.curTime, pulseAmp, pulseWidth, pulseWavelength) + pulseAmp
...
def avgpulse_r2(sim):
    ...
    global pulseWidth
    pulseWidth = (float(curPoint) / (dataPointCount - 1)) * maxPulseWidth
    sim.r2 = pulseAmp * (pulseWidth / pulseWavelength) + pulseAmp
...
filename = "PULSER2_sim_N={0}_r0={1}_r1={2}_r2={3}_u1={4}_u2={5}_SPDP={6}".format(mySim.N, mySim.r0, mySim.r1, mySim.r2, mySim.u1, mySim.u2, simsPerDataPoint)
